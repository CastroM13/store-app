...
class OrdersResourceIT {
     ...
     *
     * @see com.dev.store.repository.search.OrdersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Orders createEntity(EntityManager em) {
        Orders orders = new Orders().idOrder(DEFAULT_ID_ORDER).idOrderProducts(DEFAULT_ID_ORDER_PRODUCTS).total(DEFAULT_TOTAL);
        return orders;
    }
    ...
    public static Orders createUpdatedEntity(EntityManager em) {
        Orders orders = new Orders().idOrder(UPDATED_ID_ORDER).idOrderProducts(UPDATED_ID_ORDER_PRODUCTS).total(UPDATED_TOTAL);
        return orders;
    }
    ...
    void createOrders() throws Exception {
        ...
        assertThat(testOrders.getIdOrder()).isEqualTo(DEFAULT_ID_ORDER);
        assertThat(testOrders.getIdOrderProducts()).isEqualTo(DEFAULT_ID_ORDER_PRODUCTS);
    ...
    void putNewOrders() throws Exception {
        ...
        updatedOrders.idOrder(UPDATED_ID_ORDER).idOrderProducts(UPDATED_ID_ORDER_PRODUCTS).total(UPDATED_TOTAL);
        ...
        Orders testOrders = ordersList.get(ordersList.size() - 1);
        assertThat(testOrders.getIdOrder()).isEqualTo(UPDATED_ID_ORDER);
        assertThat(testOrders.getIdOrderProducts()).isEqualTo(UPDATED_ID_ORDER_PRODUCTS);
        assertThat(testOrders.getTotal()).isEqualTo(UPDATED_TOTAL);

        // Validate the Orders in Elasticsearch
        verify(mockOrdersSearchRepository).save(testOrders);
    }
    ...
    void partialUpdateOrdersWithPatch() throws Exception {
        ...
        partialUpdatedOrders.idOrder(UPDATED_ID_ORDER).total(UPDATED_TOTAL);
    ...
    void fullUpdateOrdersWithPatch() throws Exception {
        ...
        partialUpdatedOrders.idOrder(UPDATED_ID_ORDER).idOrderProducts(UPDATED_ID_ORDER_PRODUCTS).total(UPDATED_TOTAL);
    ...
    void searchOrders() throws Exception {
        ...
        // Initialize the database
        ordersRepository.saveAndFlush(orders);
        when(mockOrdersSearchRepository.search(queryStringQuery("id:" + orders.getId()))).thenReturn(Collections.singletonList(orders));
