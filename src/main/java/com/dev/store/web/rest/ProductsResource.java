...
/**
 * REST controller for managing {@link com.dev.store.domain.Products}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductsResource {
    ...
    public ProductsResource(ProductsRepository productsRepository, ProductsSearchRepository productsSearchRepository) {
    ...
    public ResponseEntity<Products> partialUpdateProducts(
        ...
        Optional<Products> result = productsRepository
            ...
            .map(
                existingProducts -> {
                    if (products.getIdProducts() != null) {
                        existingProducts.setIdProducts(products.getIdProducts());
                    }
                    if (products.getName() != null) {
                        existingProducts.setName(products.getName());
                    }
                    if (products.getValue() != null) {
                        existingProducts.setValue(products.getValue());
                    }
