...
export class ProductsService {
  ...
  update(products: IProducts): Observable<EntityResponseType> {
    return this.http.put<IProducts>(`${this.resourceUrl}/${getProductsIdentifier(products) as number}`, products, { observe: 'response' });
  }

  partialUpdate(products: IProducts): Observable<EntityResponseType> {
    return this.http.patch<IProducts>(`${this.resourceUrl}/${getProductsIdentifier(products) as number}`, products, {
      observe: 'response',
    });
  }
